...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull LinearLayout rootView, @NonNull CornerLabelView cornerLabel,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppBinding((LinearLayout) rootView, cornerLabel, icon, name);
    }
